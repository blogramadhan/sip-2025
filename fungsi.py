...
def logo():
    st.logo(image="https://storage.googleapis.com/bukanamel/img/sip-spse.png", icon_image="https://storage.googleapis.com/bukanamel/img/sip-spse-icon.png", size="extra-large")
