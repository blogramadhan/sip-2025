...
try:
    ...
    col_bo1.metric(label="Belanja Operasi PBJ", value=f"Rp. {format_currency(belanja_operasi_pbj, 'IDR', locale='id_ID')[3:]}")
    col_bo2.metric(label="Belanja Operasi Bansos", value=f"Rp. {format_currency(belanja_operasi_bansos, 'IDR', locale='id_ID')[3:]}")
    col_bo3.metric(label="Belanja Operasi Hibah", value=f"Rp. {format_currency(belanja_operasi_hibah, 'IDR', locale='id_ID')[3:]}")
